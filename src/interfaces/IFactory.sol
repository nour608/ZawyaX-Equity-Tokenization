...
interface IFactory {
    ...
    // Events
    event ProjectCreated(uint256 indexed projectId, address indexed founder, address equityToken, address purchaseToken, uint256 valuationUSD, uint256 totalShares, bytes32 ipfsCID);
