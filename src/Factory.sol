...
contract Factory is AccessControl, ReentrancyGuard, Pausable, DataTypes, OrderBook {
    ...
    function enableSecondaryMarket(uint256 projectId) external whenNotPaused onlyProjectFounderOrAdmin(projectId) {
    ...
    function matchOrders(uint256 projectId) public whenNotPaused returns (uint256 tradesExecuted, uint256 feeAmount) {
